...
public final class WebSocketUpHandler extends SimpleChannelInboundHandler<WebSocketFrame> {
    private static final InternalLogger log = InternalLoggerFactory.getInstance(WebSocketUpHandler.class);

    private final Channel dstChannel;
    private final Wrapper wrapper;


    public WebSocketUpHandler(Channel dstChannel, Wrapper wrapper) {
